...
const UserManagement = () => {
  ...
  const trainers = [
    { name: "Roberts", email: "matt23@gmail.com", phone: "081- xxxxx", type: "Intermediate", media: "WeChat" ,trainername :"Si Thu Naung"},
    { name: "Justin Doe", email: "justin.doe@gmail.com", phone: "082- yyyyy", type: "Advanced", media: "Instagram",trainername :"Si Thu Aung"}
];
